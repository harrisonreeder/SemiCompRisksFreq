...
ngradWB_ID_frail_mat_SM <- function(para, y1, y2, delta1, delta2, X1, X2, X3) {
    .Call(`_SemiCompRisksFreq_ngradWB_ID_frail_mat_SM`, para, y1, y2, delta1, delta2, X1, X2, X3)
}

ngradWB_ID_frail_mat_M <- function(para, y1, y2, delta1, delta2, X1, X2, X3) {
    .Call(`_SemiCompRisksFreq_ngradWB_ID_frail_mat_M`, para, y1, y2, delta1, delta2, X1, X2, X3)
}
